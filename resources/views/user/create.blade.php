        ...
        <div class="col">
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form id="formupdate" autocomplete="off" method="post" action="/users" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mt-3">
                                    <label class="form-control-label" for="role">Peran <span class="text-danger">*</span></label>
                                    <div class="custom-control custom-radio mb-3">
                                        <input onchange="onChangeRole('PPL')" name="role" class="custom-control-input" id="rolePPL" value="PPL" type="radio" {{ old('role') == 'PPL' ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="rolePPL">
                                            Pencacah Lapangan
                                        </label>
                                    </div>
                                    <div class="custom-control custom-radio mb-3">
                                        <input onchange="onChangeRole('PML')" name="role" class="custom-control-input" id="rolePML" value="PML" type="radio" {{ old('role') == 'PML' ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input name="phone_number" type="number" class="form-control @error('phone_number') is-invalid @enderror" value="{{ @old('phone_number') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-3 mb-3">
                                    ...
                                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="validationCustom03" value="{{ @old('password') }}">
                                    @error('password')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
